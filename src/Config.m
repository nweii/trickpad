...
+ (NSString *)humanNameForGesture:(NSString *)raw {
    ...
    if (phrases == nil) {
        phrases = [@{
            ...
            @"Left-Edge Click": @"Click the left edge",
            @"Right-Edge Click": @"Click the right edge",
            @"Top-Edge Click": @"Click the top edge",
            @"Bottom-Edge Click": @"Click the bottom edge",
            @"Left-Edge Top-Half Click": @"Click the top half of the left edge",
            @"Left-Edge Bottom-Half Click": @"Click the bottom half of the left edge",
            @"Right-Edge Top-Half Click": @"Click the top half of the right edge",
            @"Right-Edge Bottom-Half Click": @"Click the bottom half of the right edge",
            @"Top-Edge Left-Half Click": @"Click the left half of the top edge",
            @"Top-Edge Right-Half Click": @"Click the right half of the top edge",
            @"Bottom-Edge Left-Half Click": @"Click the left half of the bottom edge",
            @"Bottom-Edge Right-Half Click": @"Click the right half of the bottom edge",
            @"Left-Edge Top-Third Click": @"Click the top third of the left edge",
            @"Left-Edge Middle-Third Click": @"Click the middle third of the left edge",
            @"Left-Edge Bottom-Third Click": @"Click the bottom third of the left edge",
            @"Right-Edge Top-Third Click": @"Click the top third of the right edge",
            @"Right-Edge Middle-Third Click": @"Click the middle third of the right edge",
            @"Right-Edge Bottom-Third Click": @"Click the bottom third of the right edge",
            @"Top-Edge Left-Third Click": @"Click the left third of the top edge",
            @"Top-Edge Middle-Third Click": @"Click the middle third of the top edge",
            @"Top-Edge Right-Third Click": @"Click the right third of the top edge",
            @"Bottom-Edge Left-Third Click": @"Click the left third of the bottom edge",
            @"Bottom-Edge Middle-Third Click": @"Click the middle third of the bottom edge",
            @"Bottom-Edge Right-Third Click": @"Click the right third of the bottom edge",
            @"Top-Left-Corner Click": @"Click the top left corner",
            @"Top-Right-Corner Click": @"Click the top right corner",
            @"Bottom-Left-Corner Click": @"Click the bottom left corner",
            @"Bottom-Right-Corner Click": @"Click the bottom right corner",
