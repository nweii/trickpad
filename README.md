...
The app has no telemetry, analytics, or crash reporting. It uses the network only for updates. Opening a URL may cause the app that handles it to use the network.
