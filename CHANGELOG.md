...
- Accept the words of an area-click name in any order. For example, `top-half-left-edge-click` loads as `left-edge-top-half-click`. The menu and reports show the canonical name.
